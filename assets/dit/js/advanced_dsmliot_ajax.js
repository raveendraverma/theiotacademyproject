  ...
  document.getElementById("DownloadbrochForm").addEventListener("submit", function(e) {
    ...
    .then(data => {
        if (data.message === "error") {
            ...
            window.location.href=baseurly +"assets/coursesyllabus/ds-ml-and-iot-by-eict-academy-iit-guwahati/brochure.pdf";
        } else {
...
document.getElementById("DownloadProjectmb").addEventListener("submit", function(e) {
    ...
    .then(data => {
        if (data.message === "error") {
            ...
            window.location.href=baseurly +"assets/coursesyllabus/ds-ml-and-iot-by-eict-academy-iit-guwahati/project-list.pdf";
        } else {
...
document.getElementById("DownloadCurriculummb").addEventListener("submit", function(e) {
    ...
    .then(data => {
        if (data.message === "error") {
            ...
            window.location.href=baseurly +"assets/coursesyllabus/ds-ml-and-iot-by-eict-academy-iit-guwahati/curriculum.pdf";
        } else {
