...
<html lang="en">
<head>
  <title>Job Applied User Details | The IoT Academy</title>
  <meta charset="utf-8">
            ...
            <?php 
				foreach($detail as $row){
				    ...
				    echo "<tr style='width:100%;'>";
						...
						echo "<td>".$row['emp_job_category']."</td>";
						echo "<td>".$row['form_name']."</td>";
						echo "<td><a href='https://www.theiotacademy.co/uploads/resume/".$resume."'>Resume</a></td>";
