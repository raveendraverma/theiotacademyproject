...
<div class="container-fluid">
  <h4 class="text-center heading">Add New Batch</h4>
  <br>
  <form action="<?php echo base_url()?>submit-batch" method="post">
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="number" name="totalseats" class="form-control" placeholder="Total Seats" required="required"/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="time" id="starttime" name="starttime" class="form-control" required="required" placeholder="Start Time"/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="time"  id="endtime" name="endtime" class="form-control" required="required" placeholder="End Time"/>
          </div>
        </div>
      ...
      <div class="col-sm-6">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" name="batchname" class="form-control" placeholder="Enter Batch Name" required="required"/>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="number" id="duration" name="duration" class="form-control" placeholder="Enter Duration In Hours" required="required"/>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="number" id="daysquantity" name="daysquantity" class="form-control" placeholder="Days Quantity" onkeyup="updateDurations()" required="required" value="1" min="1" readonly="true">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            ...
            <input type="text" id="hoursperday" name="hoursperday" class="form-control" placeholder="Hours Per Day" onkeyup="updateDurations()" required="required" step=".5" readonly="true"/>
          </div>
        </div>
    ...
    <div class="form-group row">
          ...
          <div class="col-sm-9">
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="checkbox" name="monday" class="form-check-input checkSingle" onchange="handleCheckBox(this);"/>
                <label class="col-form-label lead checkboxlabel">Monday</label>
              </div>
              <div class="col-sm-2">
                <input type="checkbox" name="tuesday" class="form-check-input checkSingle" onchange="handleCheckBox(this);"/>
                <label class="col-form-label lead checkboxlabel">Tuesday</label>
              </div>
              <div class="col-sm-2">
                <input type="checkbox" name="wednesday" class="form-check-input checkSingle" onchange="handleCheckBox(this);"/>
                <label class="col-form-label lead checkboxlabel">Wednesday</label>
              </div>
              <div class="col-sm-2">
                <input type="checkbox" name="thrusday" class="form-check-input checkSingle" onchange="handleCheckBox(this);"/>
                <label class="col-form-label lead checkboxlabel">Thrusday</label>
              </div>

              <div class="col-sm-2">
                <input type="checkbox" name="friday" class="form-check-input checkSingle" onchange="handleCheckBox(this);"/>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="checkbox" name="saturday" class="form-check-input checkSingle" onchange="handleCheckBox(this);"/>
                <label class="col-form-label lead checkboxlabel">Saturday</label>
              </div>

              <div class="col-sm-3">
                <input type="checkbox" name="sunday" class="form-check-input checkSingle" onchange="handleCheckBox(this);"/>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    getCourseModuleListAjax($('#courseid').val());
