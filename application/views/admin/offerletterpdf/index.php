...
<head>
    <meta charset="utf-8">
    <title>Offer Letter In Pdf Format Home</title>
...
<header>
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="offer-pdf-home"><h4 class="text-white">Offer Letter</h4></a>
...
<div class="container-fluid my-5 bg-light border-primary">
    <div class="row bg-light border-dark">
        ...
        <div class="col-md-12 mb-2" id="importfrm" style="display: none;">
            <div><p class="alert alert-warning">All Field Heading name should be like that <b>Name Email Mobile Organization Domain  Startinternship Offerissuedate </b></p></div>
            <p class="import__details--text">Import CSV File Of Member Details</p>
            <form action="offer-pdf-import" method="post" enctype="multipart/form-data">
