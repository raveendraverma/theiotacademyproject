...
<div class="container my-5 bg-light border-primary">
    <div class="row bg-light border-dark">
        ...
        <div class="col-md-12 mb-2" id="importfrm" style="display: none;">
            ...
            <form action="offer-import" method="post" enctype="multipart/form-data">
                <input type="file" name="file" accept=".CSV" required/>
                <input type="submit" class="btn btn-primary" name="importSubmit" value="IMPORT">
            </form>
        </div>
        <div class="col-md-12 mb-2" id="importfrm1" style="display: none;">
            <form action="offer-store" method="post" enctype="multipart/form-data">
                <label for="usr"> Choose Offer Letter Theme : </label>
        ...
        <div class="col-md-12 mb-2" id="importfrm2" style="display: none;">
            <form action="offer-store" method="post" enctype="multipart/form-data">
                <label for="usr"> Choose New Offer Letter Theme : </label>
                <div class="custom-file mb-3">
        ...
        <table id="member_data" class="table table-striped table-bordered">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th class="text-center">Offer Letter Status</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                { 
                    ...
                    { 
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $row['domain']; ?></td>
            ...
            <div class="modal-body">
                <?php 
                    ...
                    <div class="w-50 px-5 py-1 float-left"style="min-height: 300px">
                        <a href="offer-theme?themeid=<?php echo($id)?>"><img src="<?php echo './assets/images/'.$value->template_image?>" alt="Cinque Terre" width="100%" height="300px" class="border border-dark rounded"></a>
                        <a class="btn btn-info btn-lg float-left my-3" href="offer-theme?themeid=<?php echo($id)?>">Apply Theme</a>
                    </div>
