...
<body class="bg-secondary">
    ...
    <nav class="navbar navbar-expand-sm bg-info navbar-light">
            ...
            <a class="navbar-brand" href="csv"><h1 class="text-white">UCT Offer Letter</h1></a>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <p class="alert alert-info text-dark h4 py-1 my-1"><span class="h5">Step-3 : </span>You can add Six Locater.</p>
...
<div class="container-fluid my-5" style="z-index: -1">
    ...
    <?php echo form_open('offer-add','name = "myform"'); ?>
...

     {
...

        {
            ...
            pos_var+= '<div class="form-group mb-3"><label for="coords">Position '+i+':</label><input type="text" class="form-control" name="position[]" value="Text '+i+'" readonly></div>';
                ...
                font_case += '<div class="form-group"><label for="sel2">Font Case :</label><select class="form-control" id="text_case" name="fontCase[]"><option value="1">UpperCase</option><option value="2">LowerCase</option><option value="3"selected>1st Char UpperCase</option><option value="4">1st Char Lower Case</option><option value="5">Each 1st Str UpperCase</option></select></div>';
        ...
        var cncl = '<a  class="btn btn-danger mb-5 ml-3" href="offer-home">Cancel</a>';
