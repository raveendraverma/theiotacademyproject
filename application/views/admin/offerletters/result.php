...
<head>
    <meta charset="utf-8">
    <title>Offer Letter Result</title>
...
<header id="myHeader">
    ...
    <div class="container">
        <a class="navbar-brand" href="offer-home">
            <img class="rounded" width="40" hieght="40" src="<?php echo base_url('assets/images/logo.png')?>">
        </a>
        <a class="navbar-brand" href="offer-home"><h4 class="text-white">Offer Letter</h4></a>
      ...
      <div class="collapse navbar-collapse" id="main_nav">  
        <ul class="navbar-nav ml-auto text-white">
            <li class="nav-item">
                <a class="nav-link text-white" href="offer-home">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="offer-result">Result</a>
            </li>
            <li class="nav-item">
            ...
            <!-- <li class="nav-item">
                <button type="button" name="email_button" class="mx-2 text-white btn btn-primary" id="sendMail" data-action="bulk">Send</button>
            </li> -->
...
<!-- <form method="post" action="send" name="myform" id="myform1"> -->
        ...
        <table id="member_result" class="table table-striped table-bordered p-0">
            <thead class="thead-dark">
                <tr>
                    ...
                    <!-- <th class="text-center">Mail Certificate</th> -->
            ...
            <?php
                ...
                { 
                    ...
                    { 
                        $imglnk = base_url()."assets/offerletter/".$row["offer_image"];
                        ?>
                        <tr style="margin-bottom: 5px;">
                            ...
                            <td class="text-center"><div data-toggle="modal" data-target="<?php echo "#mymodel".$row['id']?>" class="btn p-0 btn-info" style="background-image: url('<?php echo $imglnk;?>');background-size: 60px 40px;background-position: center center;"><img src="./assets/images/eye-solid.svg" alt="" width="60" height="40"></div></td>
                            <td class="text-center ln_height">
                                <?php 
                                    if($row['mail_status'] ==1)
                                    {
                                        echo '<span class="text-success mail_stts">Sent</span>';
                                        //$cbtn = '<button type="button" name="email_button" class="btn btn-warning email_button" id="'.$row['id'].'" data-id="'.$row['id'].'" data-action="single">Resend</button>';
                                    }

                                    else
                                    {
                                        echo '<span class="text-warning mail_stts">Not Sent</span>';
                                        //$cbtn = '<button type="button" name="email_button" class="btn btn-primary email_button" id="'.$row['id'].'" data-id="'.$row['id'].'" data-action="single">send</button>';
                                    }
                                ?>
                            </td>
                            <!-- <td class="text-center"><?php //echo $cbtn;?></td> -->
                        </tr>
                        <!-- Image Model  -->
                        <div class="modal fade" id="<?php echo "mymodel".$row['id']?>">
                          <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">

                              <!-- Modal Header -->
                              <div class="modal-header bg-info">
                                <h4 class="modal-title text-light"><?php echo $row['name']; ?></h4>
                                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                              </div>

                              <!-- Modal body -->
                              <div class="modal-body">
                                <img class="rounded txt" width="100%" height="100%" src="<?php echo $imglnk;?>" alt="">
                              </div>

                              <!-- Modal footer -->
                              <div class="modal-footer bg-faded">
                                <a href="<?php echo $imglnk;?>" class="btn btn-success mr-4" download>
                                Download</a>
...
<script type="text/javascript">
 ...
 //=======================Send Mail ===========================               
                $.ajax(
                {
                    url:"<?php echo base_url('offer-send');?>",
                    method:"POST",
