...
<head>
    <meta charset="utf-8">
    <title>Webinar Certificate Pdf Result</title>
...
<header id="myHeader">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="webinar-pdf-home"><h4 class="text-white">Certificate Pdf</h4></a>
      ...
      <div class="collapse navbar-collapse" id="main_nav">  
        <ul class="navbar-nav ml-auto text-white">
            <li class="nav-item">
                <a class="nav-link text-white" href="webinar-pdf-home">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="webinar-pdf-result">Result</a>
            </li>
            <li class="nav-item">
                ...
                { 
                    ...
                    { 
                        ...
                        <tr style="margin-bottom: 5px;">
                            ...
                            <td class="text-center ln_height"><a class="btn btn-primary" href="<?php echo base_url().'WebinarController/certificatepdfdetails/'. $row['id'] ?>">View</a></td>
                            <td class="text-center ln_height"><a class="btn btn-primary"  href="<?php echo base_url().'WebinarController/downloadpdfdetails/'. $row['id'] ?>">Download</a></td>
...
<script type="text/javascript">
 ...
 //=======================Send Mail ===========================               
                $.ajax(
                {
                    url:"<?php echo base_url('pdf-webinar-send');?>",
                    method:"POST",
