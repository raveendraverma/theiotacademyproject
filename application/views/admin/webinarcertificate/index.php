...
<head>
    <meta charset="utf-8">
    <title>Webinar Certificate In Pdf Format Home</title>
...
<header>
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="webinar-pdf-home"><h4 class="text-white">Webinar Certificate</h4></a>
...
<div class="container-fluid my-5 bg-light border-primary">
    <div class="row bg-light border-dark">
        ...
        <div class="col-md-12 mb-2" id="importfrm" style="display: none;">
            ...
            <form action="webinar-pdf-import" method="post" enctype="multipart/form-data">
