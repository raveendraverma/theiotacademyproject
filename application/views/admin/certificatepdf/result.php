...
<head>
    <meta charset="utf-8">
    <title>Certificate Pdf Result</title>
...
<header id="myHeader">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="certificate-pdf-home"><h4 class="text-white">Certificate Pdf</h4></a>
                ...
                { 
                    ...
                    { 
                        ...
                        <tr style="margin-bottom: 5px;">
                            ...
                            <td class="text-center ln_height"><?php echo $row['domain_name']; ?></td>
                            <td class="text-center ln_height"><a class="btn btn-primary" href="<?php echo base_url().'Certificatepdf/certificatepdfdetails/'. $row['id'] ?>">View</a></td>
                            <td class="text-center ln_height"><a class="btn btn-primary"  href="<?php echo base_url().'Certificatepdf/downloadpdfdetails/'. $row['id'] ?>">Download</a></td>
...
<script type="text/javascript">
 ...
 //=======================Send Mail ===========================               
                $.ajax(
                {
                    url:"<?php echo base_url('pdf-certificate-send');?>",
                    method:"POST",
