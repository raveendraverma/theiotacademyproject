        ...
        <table id="member_result" class="table table-striped table-bordered p-0">
            ...
            <?php
                ...
                { 
                    ...
                    { 
                        $imglnk = base_url()."assets/certificate/".$row["cert_image"];
                        ?>
                        <tr style="margin-bottom: 5px;">
                            ...
                            <td class="text-center ln_height"><?php echo $row['course']; ?></td>
                          ...
                          <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <img class="rounded txt" width="100%" height="440" src="<?php echo $imglnk;?>" alt="">
                              </div>
