...
<head>
    <meta charset="utf-8">
    <title>Industrial Visit Admin Certificate</title>
...
<header>
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="industrial-admin-certificate-home"><h4 class="text-white">Admin Industrial Visit Certificate</h4></a>
...
<div class="container-fluid my-5 bg-light border-primary">
    ...
    ?>
        ...
        <div class="col-md-12 mb-2" id="importfrm" style="display: none;">
            <div><p class="alert alert-warning">All Field Heading name should be like that <b>Name Email CollegeName Duration Domain FromDate EndDate IssueDate</b></p></div>
            <p class="import__details--text">Import CSV File Of Member Details</p>
            <form action="industrial-admin-certificate-import" method="post" enctype="multipart/form-data">
