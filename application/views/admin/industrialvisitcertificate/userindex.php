...
<head>
    <meta charset="utf-8">
    <title>Industrial Visit User Certificate In Pdf Format Home</title>
...
<header>
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="industrial-user-certificate-home"><h4 class="text-white">User Industrial Visit Certificate</h4></a>
...
<div class="container-fluid my-5 bg-light border-primary">
    <div class="row bg-light border-dark">
        ...
        <div class="col-md-12 mb-2" id="importfrm" style="display: none;">
            <div><p class="alert alert-warning">All Field Heading name should be like that <b>Name Email CollegeName VisitDate </b></p></div>
            <p class="import__details--text">Import CSV File Of Member Details</p>
            <form action="industrial-user-certificate-import" method="post" enctype="multipart/form-data">
