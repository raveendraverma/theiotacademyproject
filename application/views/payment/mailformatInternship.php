...
$GSTAmount=$cust_details['txn_ammount']*18/100;
...
<td colspan="2" style="height:20%;">
  <span style="font-size:16px;font-weight:bold;">Internship: 
<?=$cust_details['technology'].' ('.$cust_details['category'].')';?> &nbsp;</span><br>Payment Type:&nbsp; Fee
    <br><br>
</td>


<td style="height:20%; text-align:left;"><?=$cust_details['txn_ammount']?> &nbsp;<br><br><br><br></td>

<td style="height:20%; text-align:left;"> 1 &nbsp;<br><br><br><br></td>

<td style="height:20%; text-align:right;"><?=number_format($cust_details['txn_ammount'],2)?>&nbsp;<br><br><br><br></td>
