...
function getstudentAssignList(){
    ...
    $.ajax({
        url: "<?php echo base_url();?>Testcnt/studentAssignList",
        type: "post",
        async: false,
        success: function(feedback){
            ...
            try{
                ...
                for(var i in arr){  
                  appendme="<tr test_id='" + arr[i]['test_id'] + "' student_id='" + arr[i]['student_id'] + "'>";
    ...
    if(confirm("Do you want to unassign?")){
        ...
        $("#assignment-rows").find(".check").each(function(){
            if($(this).prop("checked")){
                  ...
                  $.ajax({
                        url: "<?php echo base_url();?>Testcnt/studentAssignDelete?test_id="+test_id+"&student_id="+student_id,
                        type: "post",
                        async: false,
                        success: function(feedback){
