...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Application form - Advanced Generative AI Course</title>
...
<section class="banner">
    ...
    <div class="container-fluid">
        ...
        <p class="apply-course-content">Apply for Advanced Generative AI Program</p>
        <div class="row justify-content-center gy-4">
            ...
            <form method="post" id="SubmitMlRegistrationForm" onsubmit="return false">
                ...
                <input type="hidden" name="came_from_course" value="Apply Now - Advanced Generative AI By IIT Guwahati">
                    <div class="part">
                    ...
                    <div class="part">
                        <div class="head">Why do you want to learn Advanced Generative AI Certification Course?
                        (Optional)</div>
                        <div class="form-group">
...
course (maximum 5000 characters)"></textarea>
                    ...
                    <div class="part">
                        <div class="head">Upload Resume / CV (Optional)</div>
            ...
            <div class="col-lg-5 col-md-8">
                <div class="right-part">
                    ...
                    <h2 class="head">Advanced Generative AI Certification Course</h2>
