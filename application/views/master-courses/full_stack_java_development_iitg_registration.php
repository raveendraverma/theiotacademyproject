<!DOCTYPE html>
  ...
  <head>
    <meta charset="utf-8">
    <title>Application form -Full Stack Java Developer Course By EICT Academy IIT Guwahati</title>
         ...
         <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5 order-1 order-lg-2">
                      <div class="application-detail-dv">
                          <section class="fact-card">
                              <p class="title-of-course">Full Stack Java Developer Course By EICT Academy IIT Guwahati</p>
                              <h6>Application Deadline: <strong style="font-weight:600;color: #196ae5;"><?php $this->load->view("course-deadline-date/advanced_full_stack_java_6_months_deadline")?></strong></h6>
                 ...
                 <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 order-2 order-lg-1">
                        ...
                        <div class="app-form-start-dv">
                          <form method="post" id="SubmitMlRegistrationForm" onsubmit="return false">
                               ...
                               <input type="hidden" name="came_from_course" value="Full Stack Java Developer Course By IIT Guwahati">
                              ...
                              <div class="form-group">
                                ...
                                <label for="exampleInputstatement">Why do you want to learn Full Stack Java Developer Course ? (Optional)</label>
