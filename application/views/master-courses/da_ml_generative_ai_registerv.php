<!DOCTYPE html>
  ...
  <head>
    <meta charset="utf-8">
    <title>Application form - Data Analytics, Machine Learning And generative AI Course</title>
				 ...
				 <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5 order-1 order-lg-2">
                      <div class="application-detail-dv">
                          <section class="fact-card">
                              <p class="title-of-course">Data Analytics, Machine Learning And Generative AI Course</p>
                              <h6>Apply Before: <strong style="font-weight:600;color: #196ae5;"><?php $this->load->view("course-deadline-date/ds_ml_and_genai_regdate")?></strong></h6>
                              <h6 class="mt-3">Eligibility Criteria</h6>
                              <p class="mt-1">Bachelor's degree or equivalent.</p>
                              <h6 class="mt-3">Contact Us</h6>
                              <p>Contact Us at <a href="tel:+91-9354068856">+91-9354068856</a> or mail
                              at <a href="mailto:admissions.damlai@theiotacademy.co">admissions.damlai@theiotacademy.co</a> in case of any
                              queries.</p>
                          </section>
                        </div>  
                 </div>
                 <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 order-2 order-lg-1">
                        ...
                        <div class="app-form-start-dv">
                          <form method="post" id="SubmitMlRegistrationForm" onsubmit="return false">
                               ...
                               <input type="hidden" name="came_from_course" value="Data Analytics, Machine Learning And generative AI Course">
                              ...
                              <div class="form-group">
                                ...
                                <label for="exampleInputstatement">Why do you want to learn Data Analytics, Machine Learning And Generative AI Course? (Optional)</label>
                              ...
                              <div class="text-center application-btn-dv">
                                  ...
                                  <span class="d-none text-center text-success" id="SuccessAlert"></span>
                          <span class="d-none text-center text-danger"  id="ErrorAlert"></span>
                              </div>
                          </form>
                        </div> 
                 </div>
        ...
        success: function(data) {
            if (data.message == "error") {
                ...
                if (data.message == "success") {
									$("#SubmitMlRegistrationForm")[0].reset();
									$("#SuccessAlert").html(data.response);
									$("#SuccessAlert").addClass('d-block');
									$("#SuccessAlert").removeClass('d-none');
                    $("#enqform-overlay").hide();
                } else {
                    $('#ErrorAlert').html(data.response);
                    $("#ErrorAlert").fadeOut(15000);
                }
            }
        }
    });
