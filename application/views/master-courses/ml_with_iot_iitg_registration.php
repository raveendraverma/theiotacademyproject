<!DOCTYPE html>
  ...
  <head>
    <meta charset="utf-8">
    <title>Application form - Advanced Certification in Applied Data Science, Machine Learning & AI By E&ICT Academy, IIT Guwahati</title>
				 ...
				 <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5 order-1 order-lg-2">
                      <div class="application-detail-dv">
                          <section class="fact-card">
                              <p class="title-of-course">Advanced Certification in Applied Data Science, Machine Learning & AI By E&ICT Academy, IIT Guwahati</p>
                              <h6>Application Deadline: <strong style="font-weight:600;color: #196ae5;"><?php $this->load->view("course-deadline-date/ds_ml_and_iot_9month_reg_date")?></strong></h6>
