...
class Embeddedandiotregistration extends CI_Controller{
...
public function embedded_and_iot_by_eict_iitg_registration(){

  $this->load->view('master-courses/embedded_and_iot_iitg_registration');

}
       

 public function embedded_and_iot_registration_submit_form(){
        ...
        if($this->form_validation->run()){
            ...
            $data=array(
			        ...
			        'applicant_sop'=>$this->$applicant_sop ? $applicant_sop : " ",
    ...
    public function admin_ml_iot_iitg_Email($data){
		...
		$this->email->subject('Application Request Received for Embedded Systems and IoT IIT-G through Website by ' .$data['applicant_name']);
